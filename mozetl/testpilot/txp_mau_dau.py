...
def main(bucket, prefix, input_bucket, input_prefix, run_date_string, sample_id=None):
    ...
    output_location = "s3n://{}/{}/{}/submission_date_s3={}".format(bucket, prefix, SCHEMA_VERSION, run_date_string)
...
if __name__ == "__main__":
    ...
    main(bucket, prefix, input_bucket, input_prefix, run_date, sample_id)
