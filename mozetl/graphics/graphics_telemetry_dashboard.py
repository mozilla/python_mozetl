...
existing_objects = [
    obj['Key'] for obj in s3_client.list_objects_v2(
...
def GetLinuxStatistics():
    ...
    return {
        'driverVendors': driver_vendor_map,
        'compositors': compositor_map,
    }


TimedExport(filename='linux-statistics',
